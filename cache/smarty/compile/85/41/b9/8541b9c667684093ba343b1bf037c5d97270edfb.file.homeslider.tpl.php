<?php /* Smarty version Smarty-3.1.19, created on 2016-03-14 18:42:35
         compiled from "/var/www/html/presta/themes/pinkflora/modules/homeslider/homeslider.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15857853256e6e9fbe1f0f5-64733352%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8541b9c667684093ba343b1bf037c5d97270edfb' => 
    array (
      0 => '/var/www/html/presta/themes/pinkflora/modules/homeslider/homeslider.tpl',
      1 => 1457969355,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15857853256e6e9fbe1f0f5-64733352',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56e6e9fbe77278_56967663',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e6e9fbe77278_56967663')) {function content_56e6e9fbe77278_56967663($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['page_name']->value=='index') {?>
    <!-- Module HomeSlider -->
...
" />
           ...
           <!--  <div id="bx-pager-thumb">
            	<?php  $_smarty_tpl->tpl_vars['slides'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['slides']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['homeslider_slides']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['slides']['iteration']=0;
foreach ($_from as $_smarty_tpl->tpl_vars['slides']->key => $_smarty_tpl->tpl_vars['slides']->value) {
$_smarty_tpl->tpl_vars['slides']->_loop = true;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['slides']['iteration']++;
?>
                	<?php if ($_smarty_tpl->tpl_vars['slide']->value['active']) {?>
                    	<a data-slide-index="<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['slides']['iteration']-1;?>
" href=""><img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getMediaLink(((string)@constant('_MODULE_DIR_'))."homeslider/images/".((string)mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['slides']->value['image'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8')));?>
" alt="" /></a>
                    <?php }?>
                <?php } ?>
            </div> -->
