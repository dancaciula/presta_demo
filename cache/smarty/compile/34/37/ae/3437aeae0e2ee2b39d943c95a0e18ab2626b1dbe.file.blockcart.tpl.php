<?php /* Smarty version Smarty-3.1.19, created on 2016-03-14 12:34:44
         compiled from "/var/www/html/presta/themes/default-bootstrap/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:189876806056e693c47a0436-17994255%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3437aeae0e2ee2b39d943c95a0e18ab2626b1dbe' => 
    array (
      0 => '/var/www/html/presta/themes/default-bootstrap/modules/blockcart/blockcart.tpl',
      1 => 1452091828,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '189876806056e693c47a0436-17994255',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56e693c4a74438_94874918',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e693c4a74438_94874918')) {function content_56e693c4a74438_94874918($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/presta/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_counter')) include '/var/www/html/presta/tools/smarty/plugins/function.counter.php';
?>
<!-- MODULE Block cart -->
...
<?php $_tmp72=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
<?php $_tmp73=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp71."&ipa=".$_tmp72."&id_address_delivery=".$_tmp73."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp75=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['id_customization']->value);?>
<?php $_tmp76=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp74."&ipa=".$_tmp75."&id_customization=".$_tmp76."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
" rel="nofollow">&nbsp;</a>
													</div>
