...
$(document).ready(
    ...
    $('#module-tmnewsletter').click(function(){
            ...
            { 
                var html = '<div id="newsletter_popup" class="tmnewsletter"><div class="tmnewsletter-inner"><div class="tmnewsletter-close icon"></div><div class="tmnewsletter-header"><h4>Subcribe</h4></div><div class="tmnewsletter-content"><div class="description"><p>Get the latest news &amp; updates</p></div><div class="status-message"></div><div class="form-group"><input class="form-control" placeholder="Enter your e-mail" type="email" name="email"><button class="btn btn-default tmnewsletter-submit">Subscribe</button></div></div></div></div>';
                setTemplate(html);
